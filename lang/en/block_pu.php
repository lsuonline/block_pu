...
$string['pu_docs_noneleft'] = 'You have used all of the access codes allowed for this course.<br>If you need another code, please contact <a href="mailto:answers@online.lsu.edu">answers@online.lsu.edu</a>.';
...
$string['pu_docs_invalidsfull'] = 'You have requested all of the available replacement access codes available for this course.<br>If you need another access code, please contact <a href="mailto:answers@online.lsu.edu">answers@online.lsu.edu</a>.';
$string['pu_docs_invalidsnone'] = 'If there is a problem with your access code and need another, please contact <a href="mailto:answers@online.lsu.edu">answers@online.lsu.edu</a>.';
...
$string['nomorecodes'] = 'The ProctorU access code system is out of codes, please contact <a href="mailto:answers@online.lsu.edu">answers@online.lsu.edu</a>.';
